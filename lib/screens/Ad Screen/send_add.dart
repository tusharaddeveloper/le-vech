...
class _SendAddState extends State<SendAdd> {
  ...
  getProfileData() async {
    adsData = await firebaseGetwhere('advertise', 'mobile_number', mo);
    setState(() {});
  }
        ...
        body: SafeArea(
          ...
          Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                adsData.isNotEmpty? ListView.builder(
                              ...
                              child: Container(
                                  ...
                                  child: Padding(
                                      ...
                                      child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                        ...
                                        Expanded(
                                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                            Text(adsData[index]['item_type'], overflow: TextOverflow.ellipsis, style: TextStyle(color: AppColor.themecolor, fontSize: 18, fontWeight: FontWeight.bold)),
                                            Text(adsData[index]['district'], overflow: TextOverflow.ellipsis, style: TextStyle(color: AppColor.themecolor, fontSize: 14, fontWeight: FontWeight.w500)),

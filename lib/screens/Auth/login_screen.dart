      ...
      if (mobileNoController.text.isNotEmpty) {
        ...
        _auth!.verifyPhoneNumber(
            ...
            codeSent: (String verificationId, int? resendToken) async {
              ...
              Navigator.push(context, MaterialPageRoute(builder: (context) => OtpScreen(varId: varId, mo: mobileNoController.text)));
            },
    ...
    return Scaffold(
      ...
      Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
            ...
            SizedBox(height: 24),
            AppTextField(txtValue: AppString.mobileNo, lableValue: AppString.mobileNo, controller: mobileNoController, isIcon: false, preIcon: true, maxLength: 10, keytype: TextInputType.number),
            SizedBox(height: 10),
            AppButton(
                height: 50,
                width: 170,

    ...
    return Scaffold(
        ...
        body: SafeArea(
            child: SingleChildScrollView(
                child: Obx(() {
                  return sendAddController.isGetAddLodding.value ?
                                                  ...
                                                  Expanded(
                                                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                                        ...
                                                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                                          Text(sendAddController.adsData[index]['price'], overflow: TextOverflow.ellipsis, style: TextStyle(color: AppColor.priceclr, fontSize: 18, fontWeight: FontWeight.w500)),
                                                          InkWell(onTap: () {
                                                              print(sendAddController.adsData[index].id);
                                                              sendAddController.logOut(context,index );


                                                          }, child: Icon(Icons.delete_forever, color: AppColor.iconColor, size: 24))
                                                        ])
                                                      ]))
                                                ])))));
                              })

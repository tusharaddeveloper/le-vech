...
class _BirdScreenState extends State<BirdScreen> {
  BirdController birdController = Get.put(BirdController());

  @override
  void initState() {
    setState(() {});
    birdController.sellAllBirds(context);
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Padding(
        ...
        child: Obx(() {
          return birdController.isLodingBirds.value
              ? const CircularProgressIndicator()
              : birdController.sellBirds.isNotEmpty
                  ? GridView.builder(
                      itemCount: birdController.sellBirds.length,
                      shrinkWrap: true,
...
class _ItemWidgetState extends State<ItemWidget> {
  ...
  @override
  void initState() {
    favBhangarTempList = birdController.favBirdsList[widget.index];
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      return InkWell(
          onTap: () {
            Navigator.of(context).push(MaterialPageRoute(builder: (context) => LeVechProfile(detail: birdController.sellBirds[widget.index])));
          },
          child: Card(
              elevation: 2,
                  ...
                  child: Column(children: [
                    ...
                    Card(
                        ...
                        child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(image: NetworkImage(birdController.sellBirds[widget.index]["item_img"][0].toString().isNotEmpty
                                  ? birdController.sellBirds[widget.index]["item_img"][0].toString()
                    ...
                    Padding(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          AppText(text: birdController.sellBirds[widget.index]["name"],txtColor: AppColor.primarycolorblack,size: 16,fontWeight: FontWeight.w600,overflow: TextOverflow.ellipsis),
                          ...
                          Row(children: [
                            Expanded(
                                child: Text(birdController.sellBirds[widget.index]["price"],
                            ...
                            InkWell(
                                onTap: () {
                                  ...
                                  updateData('advertise', birdController.sellBirds[widget.index].id, {'fav_user': favBhangarTempList});
                                  setState(() {});
                                },
                    ...
                    AppText(text: birdController.sellBirds[widget.index]["item_type"],txtColor: AppColor.grey700,size: 13),
                  ]))));
    });
  }
}
